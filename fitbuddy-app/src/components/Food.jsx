...
export default function FoodPage() {
  ...
  const menuItems = [
    // meals --------------------------------------------------------
    {
      ...
      type: "Meals",
      image: "../images/food/Fried Chicken Rice.png",
    },

    {
      ...
      type: "Meals",
      image: "../images/food/Fried Pork Rice.jpg",
    },

    {
      ...
      fats: "10-20",
      ingredients:
        "Chicken Drumstick, Egg Noodles, Garlic, Soy Sauce, Oyster Sauce, Star Anise, Cinnamon, Broth",
      type: "Meals",
      image: "../images/food/Chicken Noodle Soup.jpg",
    },

    {
      ...
      fats: "5-10",
      ingredients:
        "Shrimp, Squid, Fish, Glass Noodles, Chinese Cabbage, Egg, Tofu, Garlic, Suki Sauce",
      type: "Meals",
      image: "../images/food/Seafood sukiyaki.webp",
    },

    {
      ...
      fats: "3-5",
      ingredients:
        "Chicken Breast, Olive Oil, Garlic, Black Pepper, Paprika, Salt, Herbs",
      type: "Meals",
      image: "../images/food/Baked Chicken Breast.jpg",
    },

    {
      id: 6,
      name: "Kale Fried Rice with Crispy Pork",
      calories: 670,
      protein: "20-25",
      carbs: "60-70",
      fats: "30-35",
      ingredients:
        "Crispy Pork, Cooked Rice, Kale, Garlic, Soy Sauce, Oyster Sauce, Sugar, Oil",
      type: "Meals",
      image: "../images/food/Kale Fried Rice with Crispy Pork.webp",
    },

    {
      ...
      fats: "15-18",
      ingredients:
        "Eggs, Carrot, Onion, Tomato, Cabbage, Spring Onion, Salt, Pepper, Oil",
      type: "Meals",
      image: "../images/food/Vegetable Omelette.jpg",
    },

    {
      id: 8,
      name: "Riceberry Rice with Steamed Fish",
      calories: 350,
      protein: "25-30",
      carbs: "35-40",
      fats: "8-10",
      ingredients:
        "Riceberry Rice, Steamed Fish (Sea Bass or Tilapia), Garlic, Lime, Chili, Fish Sauce",
      type: "Meals",
      image: "../images/food/Riceberry Rice with Steamed Fish.jpeg",
    },

    {
      ...
      fats: "8-10",
      ingredients:
        "Soft Tofu, Minced Pork, Cabbage, Carrot, Spring Onion, Garlic, Pepper, Fish Sauce, Water",
      type: "Meals",
      image: "../images/food/Clear Soup with Tofu and Minced Pork.jpg",
    },

    {
      id: 10,
      name: "Brown Rice Fried with Shrimp",
      calories: 420,
      protein: "20-24",
      carbs: "50-55",
      fats: "10-14",
      ingredients:
        "Brown Rice, Shrimp, Egg, Garlic, Carrot, Onion, Soy Sauce, Oil, Spring Onion",
      type: "Meals",
      image: "../images/food/Brown Rice Fried with Shrimp.jpg",
    },
...

    {
      ...
      type: "Desserts",
      image: "../images/food/Ripe Mango.jpg",
    },

    {
      id: 13,
      name: "Thai Coconut Pancakes",
      calories: 230,
      protein: "2-4",
      carbs: "30-40",
      fats: "10-15",
      ingredients:
        "Coconut Milk, Rice Flour, Sugar, Salt, Pandan, Spring Onion",
      type: "Desserts",
      image: "../images/food/Khanom Krok.webp",
    },

    {
      ...
      type: "Desserts",
      image: "../images/food/Yogurt Fruit.jpg",
    },

    {
      id: 15,
      name: "Chocolate Almond Truffles",
      calories: 180,
      protein: "3-4",
      carbs: "15-18",
      fats: "12-14",
      ingredients:
        "Dark Chocolate, Almonds, Cocoa Powder, Coconut Milk, Honey, Vanilla Extract",
      type: "Desserts",
      image: "../images/food/Chocolate Almond Truffles.jpg",
    },

    {
      id: 16,
      name: "Pumpkin Chocolate Chip Oatmeal Bars",
      calories: 200,
      protein: "4-5",
      carbs: "25-30",
      fats: "8-10",
      ingredients:
        "Pumpkin Puree, Rolled Oats, Chocolate Chips, Egg, Maple Syrup, Cinnamon, Baking Powder, Vanilla Extract",
      type: "Desserts",
      image: "../images/food/Pumpkin Chocolate Chip Oatmeal Bars.webp",
    },
...

    {
      ...
      type: "Drinks",
      image: "../images/food/Cranberry Juice.jpg",
    },
  ...
  const resetOutdatedData = () => {
    ...
    keys.forEach((key) => {
      if (key.startsWith("foodCalories_") && key !== todayKey) {
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <div className="text-center text-lg space-y-4">
                ...
                <p>
                  ...
                  <span className="font-bold">Carbs:</span> {selectedItem.carbs}
                  g | 🥑 <span className="font-bold">Fats:</span>{" "}
                  {selectedItem.fats}g
                </p>
                <div>
