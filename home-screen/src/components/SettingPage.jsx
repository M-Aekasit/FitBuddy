            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <div className="py-4 flex items-center justify-between border-b border-gray-100">
                ...
                <button
                  ...
                  onClick={() => {
                    toggleNotificationSetting("foodReminder", notificationSettings, setNotificationSettings)
                    setTimeout(() => updateMainNotificationToggle(notificationSettings, setNotifications), 0)
                  }}
                >
                  <span
              ...
              <div className="py-4 flex items-center justify-between border-b border-gray-100">
                ...
                <button
                  ...
                  onClick={() => {
                    toggleNotificationSetting("waterReminder", notificationSettings, setNotificationSettings)
                    setTimeout(() => updateMainNotificationToggle(notificationSettings, setNotifications), 0)
                  }}
                >
                  <span
              ...
              <div className="py-4 flex items-center justify-between">
                ...
                <button
                  ...
                  onClick={() => {
                    toggleNotificationSetting("exerciseReminder", notificationSettings, setNotificationSettings)
                    setTimeout(() => updateMainNotificationToggle(notificationSettings, setNotifications), 0)
                  }}
                >
                  <span
